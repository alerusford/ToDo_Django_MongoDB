...
# Коллекция - это группа документов, которая хранится в БД MongoDB (эквалент таблицы в реляционных базах)
collection = current_db["youtubers"]  # current_db.youtubers

# - добавляет одну запись в коллекцию collection
...
# - добавляет несколько записей в коллекцию collection
# it_youtubers = [
